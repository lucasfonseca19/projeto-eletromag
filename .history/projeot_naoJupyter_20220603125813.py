...
fig = plt.figure()
ax = plt.axes(xlim=(1000,50000), ylim=(0,2.5))
line1, = ax.plot([], [], label = "corrente I1", color = "b")
line2, = ax.plot([], [], label = "corrente I2", color = "r")
def init():
    line1.set_data([], [])
    line2.set_data([], [])
    return line1, line2
...
plt.save('animacao.mp4', fps=30, extra_args=['-vcodec', 'libx264'])
